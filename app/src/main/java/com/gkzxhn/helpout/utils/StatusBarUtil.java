 ...
 * @author：liushaoxiang
 * @date：2019/4/17 3:06 PM
 * @description：https://blog.csdn.net/u014418171/article/details/81223681
 */
...
public class StatusBarUtil {
    ...
    public static void setStatusBarColor(Activity activity, int colorId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            SystemBarTintManagerUtils systemBarTintManager = new SystemBarTintManagerUtils(activity);
            //显示状态栏
